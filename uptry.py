...
(_____  )| |(_)| |(_____  )  |  __ (  | |   | || |(_)| ||  __ (  |  __)   |     __)
      ) || |   | |      ) |  | (  \ \ | |   | || |   | || (  \ \ | (      | (\ (   
/\____) || )   ( |/\____) |  | )___) )| (___) || )   ( || )___) )| (____/\| ) \ \__
\_______)|/     \|\_______)  |/ \___/ (_______)|/     \||/ \___/ (_______/|/   \__/
                                                                                                                                     
""")
print(red+"""
                Developed By : DeV1L N1H4d                 """)
print(cyan+"""
                   ☆☆☆ SMS BOMBER ☆☆☆      """)
print(blue+"\t\tAuto Updating Tool...")

	os.system("cd .. && rm -rf SMS && git clone https://github.com/DEVILNIHAD/SmS-Bomber > /dev/null 2>&1 && cd SmS-Bomber && python uptry.py")

os.system("clear")
print(' ')

number=str(input(red+" Enter  Number : "))
